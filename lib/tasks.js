    ...
    statusReportData.totalFormalInformal > 0
      ? `
        <li style="${paragraphStyle}">
          ...
          <strong>${statusReportData.totalFormalInformal}</strong> instanties moeten nog worden omgezet naar de je-vorm. Bekijk deze
  ...
  <body>
    ...
    <ul style="padding-left: 20px; margin: 0;">
      <li style="${paragraphStyle}">
        ...
        <strong>${statusReportData.totalFeedback}</strong> instanties hebben feedback gekregen. Bekijk deze
      ...
      <li style="${paragraphStyle}">
        ...
        <strong>${statusReportData.totalHerziening}</strong> instanties zijn gekoppeld met een gewijzigd concept. Bekijk deze
      ...
      <li style="${paragraphStyle}">
        ...
        Van <strong>${statusReportData.totalDuplicateProductIds}</strong> instanties bestaan er meerdere versies. Ga naar je 
        <a href=${LPDC_URL}>LPDC-omgeving</a>.
        <br>
