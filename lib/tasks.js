...
export function generateStatusReportPlainTextEmail(targetLabel, bestuurseenheid, statusReportData) {
  ...
  email += `- hebben ${statusReportData.totalHerziening} een herziening nodig\n`;
  email += `- hebben ${statusReportData.totalFeedback} openstaande feedback\n`;
  email += `- moeten ${statusReportData.totalFormalInformal} nog worden omgezet naar de 'je'-vorm\n\n`;

  email += `Ga naar LPDC: ${LPDC_URL}\n\n`;

  email += `Wil je deze e-mail niet langer ontvangen of je instellingen aanpassen? Klik dan hier: `;
...
export function generateStatusReportHtmlEmail(targetLabel, bestuurseenheid, statusReportData) {
  ...
  <body>
    ...
    <ul>
      <li style="margin-bottom: 15px;">hebben <strong>${statusReportData.totalHerziening}</strong> een herziening nodig</li>
      <li style="margin-bottom: 15px;">hebben <strong>${statusReportData.totalFeedback}</strong> openstaande feedback</li>
      <li style="margin-bottom: 15px;">moeten <strong>${statusReportData.totalFormalInformal}</strong> nog worden omgezet naar de 'je'-vorm</li>
    </ul>
