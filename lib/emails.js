...
export function generatePlainTextSummaryEmail(
  ...
  const isSingular = (feedbackInstances.length + reviewInstances.length + formalInformalInstances.length) === 1;
...
export function generateHtmlSummaryEmail(
  ...
  return notificationSummaryTemplate({
    targetLabel,
    lpdcUrl: LPDC_URL,
    isSingular: (feedbackInstances.length + reviewInstances.length + formalInformalInstances.length) === 1,
    isAdhoc,
